...
storiesOf('Stack', module)
  ...
  .add(
    ...
    () => {
      ...
      const direction = select('Direction', [null, ...Object.values(DIRECTIONS)], 'row');
      const wrap = boolean('Wrap', false);
      const grow = boolean('Grow', true);
      const shrink = boolean('Shrink', false);
      const basis = text('Basis', 'auto');
      const align = select('Align', [null, ...Object.values(ALIGNS)], 'start');
      const justify = select('Justify', [null, ...Object.values(JUSTIFY)], 'start');
      const spacing = select('Spacing', [null, ...Object.values(SPACINGS)], 'none');
      ...
      return (
        <Stack
          ...
          justify={justify as StackJustify}
          spacing={spacing as StackSpacing}>
          <Button type="success" iconLeft="">
            Button
          </Button>
          <Button type="warning">Button</Button>
