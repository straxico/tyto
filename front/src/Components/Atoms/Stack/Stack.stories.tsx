...
storiesOf('Stack', module)
  ...
  .add(
    ...
    () => {
      ...
      const align = select('Align', [null, ...Object.values(ALIGNS)], ALIGNS.CENTER);
      const justify = select('Justify', [null, ...Object.values(JUSTIFY)], JUSTIFY.CENTER);
      const spacing = select('Spacing', [null, ...Object.values(SPACINGS)], SPACINGS.COMPACT);
      ...
      return (
        <Stack
          ...
          <Button type="success" icon="home">
            Button
          </Button>
          <Button type="warning" icon="home">
            Button
          </Button>
        </Stack>
      );
