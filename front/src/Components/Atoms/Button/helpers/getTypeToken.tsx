...
const getTypeToken: GetTypeToken = name => ({ theme, type }) => {
  const tokens = {
    [TOKENS.backgroundButton]: {
      ...
      [TYPE_OPTIONS.TRANSPARENT]: theme.jajiga.backgroundButtonTransparent,
    },
    ...
    [TOKENS.colorTextButton]: {
      ...
      [TYPE_OPTIONS.TRANSPARENT]: theme.jajiga.colorTextButtonTransparent,
    },
    [TOKENS.colorTextButtonBordered]: {
      ...
      [TYPE_OPTIONS.TRANSPARENT]: theme.jajiga.colorTextButtonTransparentBordered,
    },
