...
describe('Card', () => {
  ...
  //   const component = mount(<Card spaceAfter={SPACINGS_AFTER.NORMAL as spaceAfterType} />);
  //   expect(component).toHaveStyleRule('margin-bottom', defaultTheme.jajiga.spaceSmall);
  // });
